            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="conversation.id.label" default="Id" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: conversationInstance, field: "id")}</td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="conversation.twams.label" default="Twams" /></td>
                            
                            <td valign="top" style="text-align: left;" class="value">
                                <ul>
                                <g:each in="${conversationInstance.twams}" var="t">
